...
-- Dumping structure for table fishbolas.pitches
CREATE TABLE IF NOT EXISTS `pitches` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `urlvideo` varchar(255) NOT NULL DEFAULT '0',
  `user` int(11) NOT NULL DEFAULT 0,
  `timest` datetime NOT NULL DEFAULT current_timestamp(),
  `title` varchar(100) NOT NULL DEFAULT 'My pitch!',
...
-- Dumping data for table fishbolas.pitches: ~0 rows (approximately)
...
-- Dumping data for table fishbolas.types: ~3 rows (approximately)
...
-- Dumping data for table fishbolas.users: ~4 rows (approximately)
